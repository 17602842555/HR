...
test("backend server config packet writes private no-secret handoff with current blockers", async () => {
  ...
  try {
    ...
    assert.equal(ownerInputs.requiredRepositorySecrets.includes("CLOUDFLARE_BOOTSTRAP_ADMIN_PASSWORD"), true);
